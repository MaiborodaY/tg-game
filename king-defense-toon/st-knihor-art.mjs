import { TINY_ST_KNIHOR_LAYOUT, ST_KNIHOR_EFFECT_LAYOUT, ST_KNIHOR_EFFECT_TIMINGS } from './tiny-st-knihor.mjs';
...
export const ST_KNIHOR_GEOMETRY = Object.freeze({
  ...
  centers: Object.freeze(Array(24).fill(64 / FRAME_SIZE)),
  baselines: Object.freeze(Array(24).fill(110 / FRAME_SIZE)),
...
export const ST_KNIHOR_EFFECTS = Object.freeze(Object.fromEntries(
