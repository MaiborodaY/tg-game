...
export const UNIT_RANK_ASSETS = {
  swordsman: {
    ...
    5: { sheet: new URL('./assets/ranks/swordsman-black-sheet.png', import.meta.url).href, art: new URL('./assets/ranks/swordsman-black-art.png', import.meta.url).href },
  },
  archer: {
    ...
    5: { sheet: new URL('./assets/ranks/archer-black-sheet.png', import.meta.url).href, art: new URL('./assets/ranks/archer-black-art.png', import.meta.url).href },
  },
  healer: {
    ...
    5: { sheet: new URL('./assets/ranks/healer-black-sheet.png', import.meta.url).href, walk: new URL('./assets/ranks/healer-black-walk.png', import.meta.url).href, cast: new URL('./assets/ranks/healer-black-cast.png', import.meta.url).href, art: new URL('./assets/ranks/healer-black-art.png', import.meta.url).href },
  },
