...
export interface GameElementTags {
  ...
  'recruitment-current-types': 'div';
  'lancer-recruitment': 'article';
  'barracks-lancer-art': 'img';
  ...
  'barracks-finish-upgrade': 'button';
  'barracks-go-market': 'button';
  'barracks-upgrade-pricing': 'small';
