...
test('existing version-two saves preserve every receipt and training credit while adding lancer at level one', () => {
  ...
  assert.deepEqual(migrated.received, { ...saved.received, lancer: 0, pantherRider: 0 });
  assert.deepEqual(migrated.legacyTrainingCredit, { ...saved.legacyTrainingCredit, lancer: 0, pantherRider: 0 });
