...
export function tinyLancerFrame(actor: AnimationActor | null | undefined, time = 0): number {
  ...
  const start = ({ '-2': 30, '-1': 27, 0: 18, 1: 21, 2: 24 } as Readonly<Record<number, number>>)[direction];
