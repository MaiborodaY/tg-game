...
const RU_TEXTS = {
  ...
  a11y_back_to_games: "Вернуться в меню",
...
export const RUNNER_TEXTS = {
  ...
  uk: {
    ...
    a11y_back_to_games: "Повернутися до меню",
  ...
  en: {
    ...
    a11y_back_to_games: "Return to the menu",
