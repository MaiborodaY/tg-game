...
const NORTHERN_PASS_WAVES: readonly NorthernWaveBlueprint[] = Object.freeze([
  ...
  wave(1.30, 1.00, 660, 44, 2, [runner("swift", 9), standard("raider", 6)]),
  wave(1.45, 0.96, 640, 50, 2, [standard("raider", 8), runner("swift", 6), icebound("warden", 3, 0.24)]),
  wave(1.70, 0.94, 620, 78, 2, [standard("raider", 8), runner("swift", 5), icebound("boss", 1, 0.42, { hpScale: 1.08, gapAfterMs: 900 })]),

  wave(1.82, 0.90, 590, 62, 3, [standard("raider", 9), runner("swift", 8), icebound("brute", 4, 0.24)]),
  wave(2.02, 0.88, 570, 68, 3, [runner("swift", 10), icebound("warden", 5, 0.3)]),
  wave(2.24, 0.86, 560, 74, 3, [standard("raider", 10), runner("swift", 8), icebound("bulwark", 2, 0.36)]),
  wave(2.48, 0.84, 540, 82, 3, [runner("swift", 9), icebound("brute", 5, 0.28), standard("shaman", 2)]),
  wave(2.76, 0.82, 520, 90, 4, [standard("raider", 9), runner("shade", 8), icebound("warden", 5, 0.34)]),
  wave(3.12, 0.80, 510, 122, 4, [icebound("bulwark", 4, 0.42), standard("shaman", 2), icebound("boss", 1, 0.52, { hpScale: 1.16, healingRadius: 118, healingRatio: 0.04, gapAfterMs: 1_100 })]),

  wave(3.38, 0.76, 490, 102, 4, [standard("raider", 10), runner("shade", 10, { eliteEvery: 7 }), icebound("warden", 6, 0.38)]),
  wave(3.72, 0.74, 470, 110, 4, [runner("swift", 13, { eliteEvery: 8 }), icebound("bulwark", 5, 0.46), standard("shaman", 3)]),
  wave(4.08, 0.72, 455, 118, 5, [runner("shade", 10, { eliteEvery: 6 }), icebound("brute", 8, 0.36), icebound("warden", 7, 0.42)]),
  wave(4.48, 0.70, 440, 126, 5, [standard("raider", 9), runner("swift", 14, { eliteEvery: 7 }), icebound("bulwark", 6, 0.5), standard("shaman", 3)]),
  wave(4.92, 0.68, 425, 136, 5, [runner("shade", 14, { eliteEvery: 6 }), icebound("warden", 8, 0.46), icebound("bulwark", 6, 0.54), standard("shaman", 4)]),
  wave(5.45, 0.66, 420, 190, 5, [runner("swift", 10, { eliteEvery: 5 }), runner("shade", 10, { eliteEvery: 5 }), icebound("bulwark", 6, 0.56), standard("shaman", 3), icebound("titan", 1, 0.68, { hpScale: 1.22, summonThresholds: [0.72, 0.42], summonCount: 3, gapAfterMs: 1_300 })]),
]);
...
function wave(
  ...
  return Object.freeze({ healthScale, rewardScale, intervalMs, clearBonus, threat, groups: Object.freeze([...groups]) });
}
