...
const ru = {
  ...
  session_mode: "Режим",
  session_hint: "Выбор сохраняется для тренировочных запусков.",
...
const uk = {
  ...
  session_mode: "Режим",
  session_hint: "Вибір зберігається для тренувальних запусків.",
...
const en = {
  ...
  session_level: "Level",
  session_mode: "Mode",
  session_hint: "Your choice is saved for practice runs.",
