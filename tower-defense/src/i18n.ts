...
const ru = {
  ...
  game_choice_eyebrow: "Игры таверны",
  game_choice_title: "Во что сыграем?",
  game_choice_body: "Выберите приключение. К этому экрану можно вернуться до начала защиты.",
  game_choice_td_title: "Защита башнями",
  game_choice_td_body: "Стройте башни и удержите 24 волны врагов.",
  game_choice_td_meta: "24 волны · рейтинг",
  game_choice_td_practice_meta: "24 волны · тренировка",
  game_choice_bridge_title: "Бридж",
  game_choice_bridge_body: "Торгуйтесь и разыгрывайте контракт против ИИ или игрока.",
  game_choice_bridge_meta: "Solo · приватный стол · без рейтинга",
  game_choice_bridge_error: "Не удалось открыть бридж. Попробуйте ещё раз.",
  game_choice_back: "К выбору игр",
...
const uk = {
  ...
  game_choice_eyebrow: "Ігри таверни",
  game_choice_title: "У що зіграємо?",
  game_choice_body: "Обери пригоду. До цього екрана можна повернутися до початку захисту.",
  game_choice_td_title: "Захист вежами",
  game_choice_td_body: "Будуй вежі та стримай 24 хвилі ворогів.",
  game_choice_td_meta: "24 хвилі · рейтинг",
  game_choice_td_practice_meta: "24 хвилі · тренування",
  game_choice_bridge_title: "Бридж",
  game_choice_bridge_body: "Торгуйся та розігруй контракт проти ШІ або гравця.",
  game_choice_bridge_meta: "Solo · приватний стіл · без рейтингу",
  game_choice_bridge_error: "Не вдалося відкрити бридж. Спробуй ще раз.",
  game_choice_back: "До вибору ігор",
...
const en = {
  ...
  game_choice_eyebrow: "Tavern games",
  game_choice_title: "What shall we play?",
  game_choice_body: "Choose an adventure. You can return here before starting the defense.",
  game_choice_td_title: "Tower Defense",
  game_choice_td_body: "Build towers and withstand 24 enemy waves.",
  game_choice_td_meta: "24 waves · ranked",
  game_choice_td_practice_meta: "24 waves · practice",
  game_choice_bridge_title: "Bridge",
  game_choice_bridge_body: "Bid and play a contract against AI or another player.",
  game_choice_bridge_meta: "Solo · private table · unranked",
  game_choice_bridge_error: "Bridge could not be opened. Please try again.",
  game_choice_back: "Back to games",
