...
test("the unified menu and restart confirmation are localized in Russian, Ukrainian, and English", () => {
  const keys = [
    ...
    "hero_detail_rank",
    "hero_detail_attack",
    "hero_detail_frontline",
    "hero_frontline_detail",
    "hero_detail_passive",
    "hero_detail_ability",
    ...
    "hero_frontline_return_short",
    "hero_frontline_armor_help",
...
test("both campaigns and the Northern Pass mechanic have complete localized mission copy", () => {
  const keys = [
    ...
    "northern_act_2",
    "northern_act_3",
    "northern_miniboss_act_1",
    "northern_miniboss_act_2",
    "northern_miniboss_act_3",
    "northern_boss_act_1",
    "northern_boss_act_2",
    "northern_boss_act_3",
    "frost_armor",
