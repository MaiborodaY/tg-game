...
test("signal fires expose a stable warm-zone radius and three immutable visual states", () => {
  ...
  assert.ok([idle, available, active].every(Object.isFrozen));
  assert.equal(new Set([idle.zone, available.zone, active.zone]).size, 3);
