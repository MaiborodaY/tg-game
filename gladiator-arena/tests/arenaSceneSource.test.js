...
test("shop equipment preview updates gear without resetting the animated pose", () => {
  ...
  assert.equal(mainSource.includes('previewShopEquipment(stagedEquipment, "paired.staged");'), true);
  assert.equal(mainSource.includes('previewShopEquipment(finalEquipment, "paired.final");'), true);
