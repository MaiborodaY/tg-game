...
test("city equipment inventory uses paper doll filters and details overlay", () => {
  ...
  assert.equal(stylesSource.includes("--city-equipment-edge-inset: 8px;"), true);
  assert.equal(stylesSource.includes("--city-equipment-edge-inset: 7px;"), true);
  ...
  assert.equal(stylesSource.includes("calc(var(--city-equipment-weapon-slot-size) + var(--city-equipment-edge-inset))"), true);
  ...
  assert.equal(stylesSource.includes("grid-template-rows: repeat(2, 36px);"), true);
  assert.equal(stylesSource.includes("grid-template-rows: repeat(2, 31px);"), true);
  assert.equal(stylesSource.includes("grid-template-rows: minmax(318px, 1.16fr) minmax(188px, 0.84fr);\n  gap: 3px;"), true);
  assert.equal(stylesSource.includes("grid-template-rows: minmax(298px, 1.08fr) minmax(166px, 0.72fr);\n    gap: 3px;"), true);
  ...
  assert.equal(stylesSource.includes("width: 108%;"), true);
  assert.equal(stylesSource.includes("height: 108%;"), true);
  assert.equal(stylesSource.includes("width: 70%;"), true);
  assert.equal(stylesSource.includes("height: 70%;"), true);
